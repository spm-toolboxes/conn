...
if nargin<1 || ischar(varargin{1}),
    ...
    h.selected=uicontrol('style','text','units','norm','position',[1,.04,.15,.9,.10]*M,'foregroundcolor',params.foregroundcolor,'backgroundcolor',params.backgroundcolor,'string','','fontname',params.fontname,'fontsize',8+CONN_gui.font_offset,'horizontalalignment','center','parent',CONN_h.screen.hfig);
