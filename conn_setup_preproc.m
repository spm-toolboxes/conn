...
steps={'default_mni','default_mnifield','default_mnidirectfield','default_ss','default_ssfield','default_ssnl',...
    ...
    'functional_label_as_unsmoothed', ...
    'functional_load', ...
    ...
    'functional_load_from_unsmoothed', ...
...
steps_names={'<HTML><b>DEFAULT PREPROCESSING PIPELINE</b> for volume-based analyses (direct normalization to MNI-space)</HTML>','<HTML><b>PREPROCESSING PIPELINE</b> for volume-based analyses (indirect normalization to MNI-space) when FieldMaps are available</HTML>','<HTML><b>PREPROCESSING PIPELINE</b> for volume-based analyses (direct normalization to MNI-space) when FieldMaps are available</HTML>','<HTML><b>PREPROCESSING PIPELINE</b> for surface-based analyses (in subject-space)</HTML>','<HTML><b>PREPROCESSING PIPELINE</b> for surface-based analyses (in subject-space) when FieldMaps are available</HTML>','<HTML><b>PREPROCESSING PIPELINE</b> for surface-based analyses (in subject-space) using nonlinear coregistration</HTML>',...
    ...
    'functional Label current functional files as "unsmoothed functional data"', ...
    ...
    'functional Load functional data from "unsmoothed functional data" dataset', ...
...
steps_descr={{'INPUT: structural&functional volumes','OUTPUT (all in MNI-space): skull-stripped normalized structural volume, Grey/White/CSF normalized masks, realigned slice-time corrected normalized smoothed functional volumes, subject movement ''realignment'' and ''scrubbing'' 1st-level covariate'},{'INPUT: structural&functional&FieldMap volumes',  'OUTPUT (all in MNI-space): skull-stripped normalized structural volume, Grey/White/CSF normalized masks, realigned&unwarp slice-time corrected normalized smoothed functional volumes, subject movement ''realignment'' and ''scrubbing'' 1st-level covariate'},{'INPUT: structural&functional&FieldMap volumes',  'OUTPUT (all in MNI-space): skull-stripped normalized structural volume, Grey/White/CSF normalized masks, realigned&unwarp slice-time corrected normalized smoothed functional volumes, subject movement ''realignment'' and ''scrubbing'' 1st-level covariate'},{'INPUT: structural&functional volumes','OUTPUT (all in subject-space): skull-stripped structural volume, Grey/White/CSF masks, realigned slice-time corrected coregistered functional volumes, subject movement ''realignment'' and ''scrubbing'' 1st-level covariate'},{'INPUT: structural&functional&VDM volumes','OUTPUT (all in subject-space): skull-stripped structural volume, Grey/White/CSF masks, realigned&unwarp slice-time corrected coregistered functional volumes, subject movement ''realignment'' and ''scrubbing'' 1st-level covariate'},{'INPUT: structural&functional volumes','OUTPUT (all in subject-space): skull-stripped structural volume, Grey/White/CSF masks, realigned slice-time corrected coregistered functional volumes, subject movement ''realignment'' and ''scrubbing'' 1st-level covariate'},...
    ...
    {'INPUT: functional volumes','OUTPUT: none ("original functional data" secondary dataset will point to current version of functional volumes)'}, ...
    {'INPUT: functional volumes','OUTPUT: none ("subject-space functional data" secondary dataset will point to current version of functional volumes)'}, ...
    {'INPUT: functional volumes','OUTPUT: none ("minimally-preprocessed functional data" secondary dataset will point to current version of functional volumes)'}, ...
    {'INPUT: functional volumes','OUTPUT: none ("realigned functional data" secondary dataset will point to current version of functional volumes)'}, ...
    {'INPUT: functional volumes','OUTPUT: none ("mni-space functional data" secondary dataset will point to current version of functional volumes)'}, ...
    {'INPUT: functional volumes','OUTPUT: none ("surface-space functional data" secondary dataset will point to current version of functional volumes)'}, ...
    {'INPUT: functional volumes','OUTPUT: none ("smoothed functional data" datasets will point to current version of functional volumes)'}, ...
    {'INPUT: functional volumes','OUTPUT: none ("unsmoothed functional data" datasets will point to current version of functional volumes)'}, ...
    ...
    {'INPUT: other imaging volumes (in secondary dataset)','OUTPUT: functional volumes (current functional volumes will point to same files as "original functional data" secondary dataset)'}, ...
    {'INPUT: other imaging volumes (in secondary dataset)','OUTPUT: functional volumes (current functional volumes will point to same files as "subject-space functional data" secondary dataset)'}, ...
    {'INPUT: other imaging volumes (in secondary dataset)','OUTPUT: functional volumes (current functional volumes will point to same files as "minimally-preprocessed functional data" secondary dataset)'}, ...
    {'INPUT: other imaging volumes (in secondary dataset)','OUTPUT: functional volumes (current functional volumes will point to same files as "realigned functional data" secondary dataset)'}, ...
    {'INPUT: other imaging volumes (in secondary dataset)','OUTPUT: functional volumes (current functional volumes will point to same files as "mni-space functional data" secondary dataset)'}, ...
    {'INPUT: other imaging volumes (in secondary dataset)','OUTPUT: functional volumes (current functional volumes will point to same files as "surface-space functional data" secondary dataset)'}, ...
    {'INPUT: other imaging volumes (in secondary dataset)','OUTPUT: functional volumes (current functional volumes will point to same files as "smoothed functional data" secondary dataset)'}, ...
    {'INPUT: other imaging volumes (in secondary dataset)','OUTPUT: functional volumes (current functional volumes will point to same files as "unsmoothed functional data" secondary dataset)'}, ...
...
if any(cellfun('length',regexp(lSTEPS,'^functional_label_as_|^structural_label_as_'))&~ismember(lSTEPS,{'functional_label_as_original', 'functional_label_as_subjectspace', 'functional_label_as_minprep', 'functional_label_as_realigned', 'functional_label_as_mnispace', 'functional_label_as_surfacespace', 'functional_label_as_smoothed','functional_label_as_unsmoothed','structural_label_as_original', 'structural_label_as_mnispace','structural_label_as_subjectspace'}))
...
for iSTEP=1:numel(STEPS)
    ...
    switch(regexprep(lower(STEP),'^run_|^update_|^interactive_',''))
            ...
            for isubject=1:numel(subjects),
                ...
                for nses=1:nsess,
                    if ismember(nses,sessions)
                        ...
                        fileout=conn_sliceintensitycorrection(filein); % note 'i' prepended to filename
                        outputfiles{isubject}{nses}{1}=char(fileout);
                    end
                end
            end
        ...
        case {'functional_label','functional_label_as_original', 'functional_label_as_subjectspace', 'functional_label_as_minprep', 'functional_label_as_realigned', 'functional_label_as_mnispace', 'functional_label_as_surfacespace', 'functional_label_as_smoothed', 'functional_label_as_unsmoothed'}
        case {'functional_load','functional_load_from_original', 'functional_load_from_subjectspace', 'functional_load_from_minprep', 'functional_load_from_realigned', 'functional_load_from_mnispace', 'functional_load_from_surfacespace', 'functional_load_from_smoothed','functional_load_from_unsmoothed'}
                        ...
                        if isempty(icov),
                            ...
                            switch(cfilename),
                                ...
                                otherwise,
                                    ...
                                    if isequal(fname,'Movement_Regressors'), matlabbatch{end}.art.motion_file_type=3; % exception for HCP files (.deg.txt)
                                    elseif isequal(lower(fext),'.mat'), temp=load(cfilename); if isstruct(temp), tempfieldname=fieldnames(temp); temp=temp.(tempfieldname{1}); end; matlabbatch{end}.art.M{end}=temp;
    ...
    if strncmp(lower(STEP),'interactive_',numel('interactive_'))
        ...
        elseif any(strcmpi(regexprep(lower(STEP),'^run_|^update_|^interactive_',''),{'functional_removescans','functional_bandpass','functional_regression','functional_sliceintensity','functional_roiextract','functional_mask','structural_mask','functional_manualorient','structural_manualorient','functional_center','functional_centerruns','functional_centertostruct','structural_center','functional_motionmask','functional_label','functional_label_as_original', 'functional_label_as_subjectspace', 'functional_label_as_minprep', 'functional_label_as_realigned', 'functional_label_as_mnispace', 'functional_label_as_surfacespace', 'functional_label_as_smoothed','functional_label_as_unsmoothed','functional_load','functional_load_from_original', 'functional_load_from_subjectspace', 'functional_load_from_minprep', 'functional_load_from_realigned', 'functional_load_from_mnispace', 'functional_load_from_surfacespace', 'functional_load_from_smoothed','functional_load_from_unsmoothed','structural_label','structural_label_as_original', 'structural_label_as_mnispace', 'structural_label_as_subjectspace', 'structural_load','structural_load_from_original', 'structural_load_from_mnispace', 'structural_load_from_subjectspace', 'functional_surface_smooth','functional_surface_resample'}))
    ...
    if ok>=0&&doimport
        ...
        switch(regexprep(lower(STEP),'^run_|^update_|^interactive_',''))
            ...
            case 'functional_label_as_unsmoothed'
                conn_datasetcopy(sets,'unsmoothed functional data',subjects);
            ...
            case 'functional_load_from_unsmoothed'
                if isempty(conn_datasetlabel('unsmoothed functional data'))&&~isempty(conn_datasetlabel('unsmoothed data')), conn_datasetcopy('unsmoothed data',sets,subjects); % note: back-compatibility
                else conn_datasetcopy('unsmoothed functional data',sets,subjects);
                end
            ...
            case 'functional_art'
                if ~sets||ALLSETSPERMISSIONS,
                    ...
                    for isubject=1:numel(subjects),
                        ...
                        nsess=intersect(1:CONN_x.Setup.nsessions(min(numel(CONN_x.Setup.nsessions),nsubject)),sessions);
                        for nses=nsess(:)'
                            try % sorts outliers by severity
                                tscrb=conn_loadtextfile(outputfiles{isubject}{nses}{1},false); % scrubbing matrix
                                [idxoutliers,nill]=find(tscrb);
                                tdata=conn_loadtextfile(outputfiles{isubject}{nses}{2},false); % QC_timeseries
                                score=max(tdata./repmat([3 0.5],size(tdata,1),1),[],2); % outlier scans
                                score=max(score,score(max(1,min(numel(score),(1:numel(score))'+1)))); % previous scan
                                if art_drop_flag>0, score(1:art_drop_flag)=inf; end % first art_drop_flag scans
                                [nill,idxoutliersorder]=sort(score(idxoutliers),'descend'); 
                                R=tscrb(:,idxoutliersorder);
                                conn_savematfile(outputfiles{isubject}{nses}{1},'R');
                            end
